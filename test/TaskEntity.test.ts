...
describe('Task Entity test', () => {
    ...
    test("Create task entity", function () {
    ...
    test('Addition task calculate', function () {
        const id = '54a7dab4-a04a-41dc-ac86-1f6c8847cd66'
        const operation = 'addition'
        const left = 7468248643685997
        const right = -2475768253056459
    ...
    test('Remanider task calculate', function () {
        const id = '54a7dab4-a04a-41dc-ac86-1f6c8847cd66'
    ...
    test('Division task calculate', function () {
        const id = '54a7dab4-a04a-41dc-ac86-1f6c8847cd66'
    ...
    test('Subtraction task calculate', function () {
        const id = '54a7dab4-a04a-41dc-ac86-1f6c8847cd66'
    ...
    test('Multiplication task calculate', function () {
        const id = '54a7dab4-a04a-41dc-ac86-1f6c8847cd66'
